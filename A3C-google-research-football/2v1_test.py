...
def get_args():
    ...
    parser.add_argument('--env_name', type=str, default='academy_pass_and_shoot_with_keeper')
    # parser.add_argument("--save_interval", type=int, default=50, help="Number of episode between savings")
    parser.add_argument("--load_path", type=str, default="/home/sz/football/A3C-google-research-football/trained_models/passShoot_train_work.pth")
    parser.add_argument("--play_episodes",type=int,default=1000)
