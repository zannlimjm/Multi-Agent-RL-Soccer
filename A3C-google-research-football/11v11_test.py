...
def get_args():
    ...
    parser.add_argument("--load_path", type=str, default="/home/sz/football/A3C-google-research-football/trained_models/11v11_fullmodel.pth")
    parser.add_argument("--play_episodes",type=int,default=20)
